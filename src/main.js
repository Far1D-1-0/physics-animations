  ...
  <main class="home">
    ...
    <section class="collection" aria-labelledby="collection-title">
      ...
      <div class="collection__section">
        <h2 class="collection__section-title">Movimiento circular uniforme</h2>
        <div class="collection__section-cards">
      ...
      <div class="collection__section">
        <h2 class="collection__section-title">Movimiento circular no uniforme</h2>
        <div class="collection__section-cards">
